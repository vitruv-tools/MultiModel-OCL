...
import tools.vitruv.multimodelocl.symboltable.*;
...
public class EvaluationVisitor extends AbstractPhaseVisitor<Value> {
   ...
   */
  @Override
  public Value visitContextDeclCS(OCLParser.ContextDeclCSContext ctx) {
   ...
   */
  @Override
  public Value visitClassifierContextCS(OCLParser.ClassifierContextCSContext ctx) {
   ...
   */
  @Override
  public Value visitIfExpCS(OCLParser.IfExpCSContext ctx) {
   ...
   */
  @Override
  public Value visitInvCS(OCLParser.InvCSContext ctx) {
   ...
   */
  @Override
  public Value visitIsEmptyOp(OCLParser.IsEmptyOpContext ctx) {
   ...
   */
  @Override
  public Value visitNotEmptyOp(OCLParser.NotEmptyOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitFirstOp(OCLParser.FirstOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.isEmpty()) {
   ...
   */
  @Override
  public Value visitLastOp(OCLParser.LastOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.isEmpty()) {
      return Value.empty(Type.optional(Type.ANY));
    }
   ...
   */
  @Override
  public Value visitReverseOp(OCLParser.ReverseOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitSizeOp(OCLParser.SizeOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitUnionOp(OCLParser.UnionOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
   ...
   */
  @Override
  public Value visitAppendOp(OCLParser.AppendOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    return receiver.union(arg);
  }
   ...
   */
  @Override
  public Value visitFlattenOp(OCLParser.FlattenOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitAbsOp(OCLParser.AbsOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitLengthOp(OCLParser.LengthOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() == 1) {
   ...
   */
  @Override
  public Value visitConcatOp(OCLParser.ConcatOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitToUpperOp(OCLParser.ToUpperOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitToLowerOp(OCLParser.ToLowerOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitIndexOfOp(OCLParser.IndexOfOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitEqualsIgnoreCaseOp(OCLParser.EqualsIgnoreCaseOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitSelectOp(OCLParser.SelectOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitOneOp(OCLParser.OneOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<String> iterVars = new ArrayList<>();
    for (TerminalNode id : ctx.iteratorVarList().ID()) {
      iterVars.add(id.getText());
   ...
   */
  @Override
  public Value visitAnyOp(OCLParser.AnyOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<String> iterVars = new ArrayList<>();
    for (TerminalNode id : ctx.iteratorVarList().ID()) {
      iterVars.add(id.getText());
   ...
   */
  @Override
  public Value visitIsUniqueOp(OCLParser.IsUniqueOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<String> iterVars = new ArrayList<>();
    for (TerminalNode id : ctx.iteratorVarList().ID()) {
      iterVars.add(id.getText());
   ...
   */
  @Override
  public Value visitSortedByOp(OCLParser.SortedByOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<String> iterVars = new ArrayList<>();
    for (TerminalNode id : ctx.iteratorVarList().ID()) {
      iterVars.add(id.getText());
   ...
   */
  @Override
  public Value visitCollectNestedOp(OCLParser.CollectNestedOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<String> iterVars = new ArrayList<>();
    for (TerminalNode id : ctx.iteratorVarList().ID()) {
      iterVars.add(id.getText());
   ...
   */
  @Override
  public Value visitIterateOp(OCLParser.IterateOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitRejectOp(OCLParser.RejectOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitCollectOp(OCLParser.CollectOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitForAllOp(OCLParser.ForAllOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitExistsOp(OCLParser.ExistsOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitIncludesAllOp(OCLParser.IncludesAllOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
   ...
   */
  @Override
  public Value visitExcludesAllOp(OCLParser.ExcludesAllOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    for (OCLElement elem : arg.getElements()) {
      if (receiver.includes(elem)) {
   ...
   */
  @Override
  public Value visitCountOp(OCLParser.CountOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    if (arg.size() != 1) {
   ...
   */
  @Override
  public Value visitPrependOp(OCLParser.PrependOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    if (arg.size() != 1) {
   ...
   */
  @Override
  public Value visitInsertAtOp(OCLParser.InsertAtOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitSymmetricDifferenceOp(OCLParser.SymmetricDifferenceOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    List<OCLElement> results = new ArrayList<>();
    for (OCLElement elem : receiver.getElements()) {
   ...
   */
  @Override
  public Value visitDivOp(OCLParser.DivOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
   ...
   */
  @Override
  public Value visitModOp(OCLParser.ModOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
    if (receiver.size() != 1 || arg.size() != 1) {
   ...
   */
  @Override
  public Value visitEqualityComparison(OCLParser.EqualityComparisonContext ctx) {
   ...
   */
  @Override
  public Value visitInequalityComparison(OCLParser.InequalityComparisonContext ctx) {
    return evaluateBinaryComparison(
        ctx.left, ctx.right, ctx, (left, right) -> !OCLElement.semanticEquals(left, right));
  }
   ...
   */
  @Override
  public Value visitLessThanComparison(OCLParser.LessThanComparisonContext ctx) {
    return evaluateBinaryComparison(
   ...
   */
  @Override
  public Value visitLessThanOrEqualComparison(OCLParser.LessThanOrEqualComparisonContext ctx) {
    return evaluateBinaryComparison(
        ctx.left, ctx.right, ctx, (left, right) -> OCLElement.compare(left, right) <= 0);
  }
   ...
   */
  @Override
  public Value visitGreaterThanComparison(OCLParser.GreaterThanComparisonContext ctx) {
    return evaluateBinaryComparison(
        ctx.left, ctx.right, ctx, (left, right) -> OCLElement.compare(left, right) > 0);
  }
  ...
  public Value visitGreaterThanOrEqualComparison(
      OCLParser.GreaterThanOrEqualComparisonContext ctx) {
    return evaluateBinaryComparison(
        ctx.left, ctx.right, ctx, (left, right) -> OCLElement.compare(left, right) >= 0);
  }
   ...
   */
  @Override
  public Value visitLogicalAnd(OCLParser.LogicalAndContext ctx) {
   ...
   */
  @Override
  public Value visitLogicalOr(OCLParser.LogicalOrContext ctx) {
    return evaluateBinaryLogical(ctx.left, ctx.right, ctx, (left, right) -> left || right);
  }
   ...
   */
  @Override
  public Value visitLogicalXor(OCLParser.LogicalXorContext ctx) {
    return evaluateBinaryLogical(ctx.left, ctx.right, ctx, (left, right) -> left ^ right);
  }
   ...
   */
  @Override
  public Value visitImplication(OCLParser.ImplicationContext ctx) {
    Value leftValue = visit(ctx.left);
    Value rightValue = visit(ctx.right);
  ...
  private Value visitNavigationWithReceiver(
      OCLParser.NavigationChainCSContext ctx, Value receiver) {

    OCLParser.NavigationTargetCSContext target = ctx.navigationTargetCS();
    // Use visitor pattern to dispatch based on navigation target type
    return target.accept(
        new OCLBaseVisitor<Value>() {
          @Override
          ...
          public Value visitOperationNav(OCLParser.OperationNavContext ctx) {
            OCLParser.OperationCallContext opCtx = ctx.operationCall();
   ...
   */
  private Value visitOperationCallWithReceiver(OCLParser.OperationCallContext ctx, Value receiver) {
   ...
   */
  @Override
  public Value visitAllInstancesOp(OCLParser.AllInstancesOpContext ctx) {
  ...
  private Value visitPropertyAccessWithReceiver(
      OCLParser.PropertyAccessContext ctx, Value receiver) {
   ...
   */
  @Override
  public Value visitOclIsKindOfOp(OCLParser.OclIsKindOfOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitOclIsTypeOfOp(OCLParser.OclIsTypeOfOpContext ctx) {
    Value receiver = receiverStack.peek();
    Type targetType = nodeTypes.get(ctx.type);
   ...
   */
  @Override
  public Value visitPrefixedQualified(OCLParser.PrefixedQualifiedContext ctx) {
   ...
   */
  @Override
  public Value visitCollectionLiteralExpCS(OCLParser.CollectionLiteralExpCSContext ctx) {
   ...
   */
  @Override
  public Value visitCollectionArguments(OCLParser.CollectionArgumentsContext ctx) {
    List<OCLElement> elements = new ArrayList<>();

    for (OCLParser.CollectionLiteralPartCSContext partCtx : ctx.collectionLiteralPartCS()) {
   ...
   */
  @Override
  public Value visitCeilingOp(OCLParser.CeilingOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<OCLElement> results = new ArrayList<>();
    for (OCLElement elem : receiver.getElements()) {
      if (elem.tryGetInt() != null) {
   ...
   */
  @Override
  public Value visitCollectionLiteralPartCS(OCLParser.CollectionLiteralPartCSContext ctx) {
   ...
   */
  @Override
  public Value visitLiftOp(OCLParser.LiftOpContext ctx) {
    Value receiver = receiverStack.peek();
   ...
   */
  @Override
  public Value visitNumberLit(OCLParser.NumberLitContext ctx) {
   ...
   */
  @Override
  public Value visitStringLit(OCLParser.StringLitContext ctx) {
    String text = ctx.getText();
   ...
   */
  @Override
  public Value visitBooleanLit(OCLParser.BooleanLitContext ctx) {
    String text = ctx.getText();
   ...
   */
  @Override
  public Value visitSelfExpCS(OCLParser.SelfExpCSContext ctx) {
    VariableSymbol selfSymbol = symbolTable.resolveVariable("self");
   ...
   */
  @Override
  public Value visitVariableDeclaration(OCLParser.VariableDeclarationContext ctx) {
    String varName = ctx.varName.getText();
   ...
   */
  @Override
  public Value visitNestedExpCS(OCLParser.NestedExpCSContext ctx) {
   ...
   */
  @Override
  public Value visitSpecificationCS(OCLParser.SpecificationCSContext ctx) {
    Value result = null;
  ...
  @Override
  public Value visitExpCS(OCLParser.ExpCSContext ctx) {
    return visit(ctx.infixedExpCS());
  }

  /** Delegates to prefixedExpCS. */
  @Override
  public Value visitPrefixedExpr(OCLParser.PrefixedExprContext ctx) {
    return visit(ctx.prefixedExpCS());
  }

  /** Delegates to literalExpCS. */
  @Override
  public Value visitLiteral(OCLParser.LiteralContext ctx) {
    return visit(ctx.literalExpCS());
  }

  /** Delegates to ifExpCS. */
  @Override
  public Value visitConditional(OCLParser.ConditionalContext ctx) {
   ...
   */
  @Override
  public Value visitLetExpCS(OCLParser.LetExpCSContext ctx) {
  ...
  @Override
  public Value visitLetBinding(OCLParser.LetBindingContext ctx) {
    return visit(ctx.letExpCS());
  }

  /** Delegates to collectionLiteralExpCS. */
  @Override
  public Value visitCollectionLiteral(OCLParser.CollectionLiteralContext ctx) {
    return visit(ctx.collectionLiteralExpCS());
  }

  /** Delegates to typeLiteralCS. */
  @Override
  public Value visitTypeLiteral(OCLParser.TypeLiteralContext ctx) {
    return visit(ctx.typeLiteralExpCS());
  }

  /** Delegates to nestedExpCS. */
  @Override
  public Value visitNested(OCLParser.NestedContext ctx) {
    return visit(ctx.nestedExpCS());
  }

  /** Delegates to selfExpCS. */
  @Override
  public Value visitSelf(OCLParser.SelfContext ctx) {
    return visit(ctx.selfExpCS());
  }

  /** Delegates to variableExpCS. */
  @Override
  public Value visitVariable(OCLParser.VariableContext ctx) {
  ...
  @Override
  public Value visitTypeExpCS(OCLParser.TypeExpCSContext ctx) {
  ...
  @Override
  public Value visitTypeLiteralCS(OCLParser.TypeLiteralCSContext ctx) {
    return Value.empty(Type.ANY);
  }

  /** Collection types have no runtime value. */
  @Override
  public Value visitCollectionTypeCS(OCLParser.CollectionTypeCSContext ctx) {
  ...
  @Override
  public Value visitCollectionTypeIdentifier(OCLParser.CollectionTypeIdentifierContext ctx) {
    return Value.empty(Type.ANY);
  }

  /** Primitive types have no runtime value. */
  @Override
  public Value visitPrimitiveTypeCS(OCLParser.PrimitiveTypeCSContext ctx) {
    return Value.empty(Type.ANY);
  }

  /** Type names have no runtime value. */
  @Override
  public Value visitTypeNameExpCS(OCLParser.TypeNameExpCSContext ctx) {
    return Value.empty(Type.ANY);
  }

  /** Type literal expressions have no runtime value. */
  @Override
  public Value visitTypeLiteralExpCS(OCLParser.TypeLiteralExpCSContext ctx) {
    return visit(ctx.typeLiteralCS());
  }
   ...
   */
  @Override
  public Value visitNavigationChainCS(OCLParser.NavigationChainCSContext ctx) {
   ...
   */
  @Override
  public Value visitVariableDeclarations(OCLParser.VariableDeclarationsContext ctx) {
   ...
   */
  @Override
  public Value visitAsSetOp(OCLParser.AsSetOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<OCLElement> elements = new ArrayList<>(receiver.getElements());
    Type elemType = receiver.getRuntimeType().getElementType();
   ...
   */
  @Override
  public Value visitAsBagOp(OCLParser.AsBagOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<OCLElement> elements = new ArrayList<>(receiver.getElements());
    Type elemType = receiver.getRuntimeType().getElementType();
   ...
   */
  @Override
  public Value visitAsSequenceOp(OCLParser.AsSequenceOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<OCLElement> elements = new ArrayList<>(receiver.getElements());
    Type elemType = receiver.getRuntimeType().getElementType();
   ...
   */
  @Override
  public Value visitAsOrderedSetOp(OCLParser.AsOrderedSetOpContext ctx) {
    Value receiver = receiverStack.peek();
    List<OCLElement> elements = new ArrayList<>(receiver.getElements());
    Type elemType = receiver.getRuntimeType().getElementType();
   ...
   */
  @Override
  public Value visitAtOp(OCLParser.AtOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value indexVal = visit(ctx.index);
   ...
   */
  @Override
  public Value visitSubSequenceOp(OCLParser.SubSequenceOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value startVal = visit(ctx.start);
    Value endVal = visit(ctx.end);
   ...
   */
  @Override
  public Value visitCharactersOp(OCLParser.CharactersOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitTokenizeOp(OCLParser.TokenizeOpContext ctx) {
    Value receiver = receiverStack.peek();
    if (receiver.size() != 1) {
   ...
   */
  @Override
  public Value visitIntersectionOp(OCLParser.IntersectionOpContext ctx) {
    Value receiver = receiverStack.peek();
    Value arg = visit(ctx.arg);
   ...
   */
  @Override
  public Value visitToIntegerOp(OCLParser.ToIntegerOpContext ctx) {
    Value receiver = receiverStack.peek();
    String str = receiver.getElements().get(0).tryGetString();
   ...
   */
  @Override
  public Value visitToRealOp(OCLParser.ToRealOpContext ctx) {
    Value receiver = receiverStack.peek();
    String str = receiver.getElements().get(0).tryGetString();
   ...
   */
  @Override
  public Value visitSubstituteAllOp(OCLParser.SubstituteAllOpContext ctx) {
    Value receiver = receiverStack.peek();
    String str = receiver.getElements().get(0).tryGetString();
   ...
   */
  @Override
  public Value visitSubstituteFirstOp(OCLParser.SubstituteFirstOpContext ctx) {
    Value receiver = receiverStack.peek();
    String str = receiver.getElements().get(0).tryGetString();
   ...
   */
  @Override
  public Value visitMatchesOp(OCLParser.MatchesOpContext ctx) {
    Value receiver = receiverStack.peek();
    String str = receiver.getElements().get(0).tryGetString();
  ...
  @Override
  public Value visitOnespace(OCLParser.OnespaceContext ctx) {
    return Value.empty(Type.ANY);
  }
}
