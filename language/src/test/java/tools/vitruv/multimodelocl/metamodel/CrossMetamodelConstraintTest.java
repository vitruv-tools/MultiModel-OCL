 ...
 *
 * <p>This test suite validates MultiModelOCLInterface's ability to evaluate constraints that span
 * multiple metamodels using allInstances() to access objects from other metamodels. Tests cover
