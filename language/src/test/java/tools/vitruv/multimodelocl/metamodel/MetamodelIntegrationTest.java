 ...
 *******************************************************************************/
package tools.vitruv.multimodelocl.metamodel;
...
/**
 * Integration test suite for metamodel loading and access in MultiModelOCLInterface.
 *
 ...
 * constraint evaluation. The MetamodelWrapper serves as the bridge between MultiModelOCLInterface's
 * constraint language and the underlying Eclipse Modeling Framework (EMF) metamodel infrastructure.
 *
 * <h2>Metamodel Integration Overview</h2>
 *
 * The MultiModelOCLInterface compiler integrates with EMF metamodels to enable:
 *
 * <ul>
 ...
 *
 * MultiModelOCLInterface uses qualified names to reference metaclasses from specific metamodels:
 *
 * <pre>{@code
 * metamodel::ClassName
 * }</pre>
