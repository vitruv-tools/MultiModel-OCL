 ...
 *
 * <p>This test suite validates that MultiModelOCLInterface can correctly evaluate constraints
 * defined within a single metamodel context. Tests cover fundamental OCL features including
 * attribute access, reference navigation, collection operations, and iterator expressions. All
 * constraints use the spaceMission metamodel which models spacecraft, missions, and payloads.
 *
