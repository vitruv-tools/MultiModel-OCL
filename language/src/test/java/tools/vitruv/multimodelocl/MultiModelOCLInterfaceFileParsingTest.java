...
/**
 * Test suite for parsing MultiModelOCLInterface constraint files from the filesystem.
 *
 ...
 */
public class MultiModelOCLInterfaceFileParsingTest {
  ...
  public void testParseValidFiles(String fileName) throws IOException {
    ...
    OCLLexer lexer = new OCLLexer(cs);
