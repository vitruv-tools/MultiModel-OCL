...
/**
 * Integration tests for the {@link MultiModelOCLCLI} command-line interface.
 *
 ...
 */
public class MultiModelOCLCLITest {
  ...
  public void testVersionCommand() {
    MultiModelOCLCLI.main(new String[] {"version"});
  ...
  public void testExtractNamedConstraint() {
    ...
    assertEquals("myInvariant", MultiModelOCLCLI.extractConstraintName(constraint));
  }
  ...
  public void testExtractUnnamedConstraint() {
    ...
    assertEquals("unknown", MultiModelOCLCLI.extractConstraintName(constraint));
  }
  ...
  public void testExtractConstraintNameWithWhitespace() {
    ...
    assertEquals("myName", MultiModelOCLCLI.extractConstraintName(constraint));
  }
  ...
  public void testExtractConstraintNameSingleLine() {
    ...
    assertEquals("singleLine", MultiModelOCLCLI.extractConstraintName(constraint));
  }
  ...
  public void testExtractConstraintNameQualifiedContext() {
    ...
    assertEquals("overlapping", MultiModelOCLCLI.extractConstraintName(constraint));
  }
  ...
  public void testExtractConstraintNameWithParenthesizedSpec() {
    ...
    assertNotNull(MultiModelOCLCLI.extractConstraintName(constraint));
  }
}