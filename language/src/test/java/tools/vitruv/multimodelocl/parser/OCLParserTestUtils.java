...
/**
 * Utility class providing helper methods for parsing and testing MultiModelOCLInterface
 * constraints.
 *
 ...
 * @see MultiModelOCLInterfaceFileParsingTest Example usage for file-based parsing tests
 */
public class OCLParserTestUtils {

  /**
   * Parses a MultiModelOCLInterface constraint string and returns the parse tree.
   *
  ...
  /**
   * Parses a MultiModelOCLInterface constraint file and returns the parse tree.
   *
